            ...
            $.ajax({
                ...
                success : function(response) {
                    ...
                    if (response != 0) {
                        ...
                        // localStorage.setItem('pacientesjs', JSON.stringify(response.pacientes))
                        // localStorage.setItem('tipo_patrones', JSON.stringify(response.tiposPatrones))
                        ...
                        // pacientesjson = JSON.parse(localStorage.pacientesjs)
                        // tipoPatronesjson = JSON.parse(localStorage.tipo_patrones)
                        // patronesjson = JSON.parse(localStorage.patrones)
