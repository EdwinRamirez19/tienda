                ...
                .then(stream => {
                    ...
                    mediaRecorder.addEventListener("stop", () => {
                        ...
                        formData.append("audio", blobAudio);
                         const RUTA_SERVIDOR = "/audio/guardar.php";
  
                        // const RUTA_SERVIDOR = '/guardarAudio';
                        $duracion.textContent = "Cargando audio, Espere Por Favor...";
                        fetch(RUTA_SERVIDOR, {
                                method: "POST",
                                // header: new Headers({
                            ...
                            .then(respuestaComoTexto => {
                                ...
                                document.getElementById('audio').value = '/audio/'+respuestaComoTexto;
                                // Abrir el archivo, es opcional y solo lo pongo como demostración
                                $duracion.innerHTML = `<strong id="lectura_audio correctamente">Audio Cargado.</strong>&nbsp; <br><audio  width ="30px" height ="20px"class="my_audio" id="audio_grabado" controls preload="auto"><source src="${'/audio/'+respuestaComoTexto}"></audio>`
                            })
                    });
                })
